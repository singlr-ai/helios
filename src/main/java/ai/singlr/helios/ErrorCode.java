...
public final class ErrorCode {
  ...
  public static ErrorCode lookup(int httpCode) {
    var errorCode = REGISTRY.values().stream().filter(e -> e.httpCode == httpCode).findFirst();
    return errorCode.orElse(INTERNAL);
  }
}
