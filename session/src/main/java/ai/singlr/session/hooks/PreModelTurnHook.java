 ...
 * HookOutcome.Inject} queues a synthetic user message before the call; {@link HookOutcome.Stop}
 * terminates the session. {@link HookOutcome.MutateInput} and {@link HookOutcome.Block} are not
