...
public final class CoreBlockSql {
   ...
   * description}, {@code max_size}, and {@code updated_at}.
   */
  public static final String UPSERT =
      """
      INSERT INTO %s.helios_core_blocks
        (agent_id, block_name, description, data, max_size, created_at, updated_at)
  ...
  public static final String FIND_ALL =
      """
      SELECT agent_id, block_name, description, data, max_size, created_at, updated_at
